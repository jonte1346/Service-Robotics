...
CytronMD motorRight(PWM_PWM, 13, 6);

// Ultrasonic sensors
NewPing sonarFront(TRIGGER_PIN, FRONT_ECHO_PIN, MAX_DISTANCE);
NewPing sonarRight(TRIGGER_PIN, RIGHT_ECHO_PIN, MAX_DISTANCE);
NewPing sonarLeft(TRIGGER_PIN, LEFT_ECHO_PIN, MAX_DISTANCE);
